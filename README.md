...
### 🚀 About Me
- ⚙️ **Backend:** Solid experience building resilient RESTful APIs and microservices using **Java**, **Spring Boot**, **Quarkus**, and **Python**.
- 🖥️ **Frontend:** Creating engaging user interfaces with **React**, **Angular**, **Vue**, and modern **JavaScript/TypeScript**.
- 🗄️ **Data & Infra:** Event-driven architectures with **Apache Kafka**, Distributed Tracing, and relational databases.
...
<div style="display: flex; gap: 15px; align-items: center; margin-bottom: 10px;">
  ...
  <img alt="Quarkus" height="40" width="40" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/quarkus/quarkus-original.svg">
